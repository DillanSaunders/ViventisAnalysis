...
def tiff2BDVConversion(ExperimentPath=Path("Choose Experiment folder"),Input_Key:str="*Fused*",Time_Start:int=0,Time_End:int=-1,CRSID:str='ddzs2')->str:
    ...
    tiff_conversion.experiment2bdv(ExperimentPath,Input_Key,ExperimentPath,Time_Start,Time_End,CRSID,'gzip','int16',stor_location=Path("\\\\gen-nas-pc-002\\Room-225\\Room225_SharedFolder\\ViventisLS2_data"),pyramid_levels = ((1, 4, 4),(2, 8, 8),(4, 16, 16)),chunk_dims=((4, 250, 250),(4, 250, 250), (4, 250, 250), (4, 250, 250)))
